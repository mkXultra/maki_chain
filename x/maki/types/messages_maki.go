...
func NewMsgCreateMaki(creator string, unit sdk.Coins, expiredHour uint64) *MsgCreateMaki {
...
func NewMsgUpdateMaki(creator string, id uint64, unit sdk.Coins, expiredHour uint64) *MsgUpdateMaki {
